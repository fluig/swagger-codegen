...
public class Swift4FluigCodegen extends DefaultCodegen implements CodegenConfig {
     ...
     */
    public Swift4FluigCodegen() {
        super();
        outputFolder = "code";
        modelTemplateFiles.put("model.mustache", ".swift");
        apiTemplateFiles.put("operations.mustache", ".swift");
        embeddedTemplateDir = templateDir = "swift4fluig";
        apiPackage = "";
        ...
        cliOptions.add(new CliOption(USE_VERSION, "Lib version").defaultValue("1"));
    }
    ...
    public void processOpts() {
        ...
        if(!additionalProperties.containsKey(USE_VERSION)) {
            additionalProperties.put(USE_VERSION, "V1");
        }
        setUseVersion((String) additionalProperties.get(USE_VERSION));
        ...
        //                                        "",
        //                                        "Cartfile"));
        supportingFiles.add(new SupportingFile("api.mustache",
                                               sourceFolder,
                                               "FluigApi.swift"));
        ...
        if (allDefinitions != null) {
            ...
            while (parentSchema != null) {
                ...
                final CodegenModel parentCodegenModel = super.fromModel(codegenModel.parent,
                                                                        parentModel,
                                                                        allDefinitions);
                codegenModel = Swift4FluigCodegen.reconcileProperties(codegenModel, parentCodegenModel);
